...
const view = (state,{
	...
	function openNav() {
		...
		document.getElementById("question").style.marginLeft = "250px";
	}
	function closeNav() {
		document.getElementById("mySidebar").style.width = "0";
		document.getElementById("question").style.marginLeft = "0";
	}
	return (
		<div id="body">
			<div id="mySidebar">
				...
				<section>
					<div id="front_img">
						...
						<map id="front_image" name="frontmap">
							...
							<area
								alt="Right_Hand" title="Right Hand"
							...
							<area
								alt="Left_Thigh" title="Left Thigh"
							...
							<area
								alt="Right_Thigh" title="Right Thigh"
							...
							<area
								alt="Right_Knee" title="Right Knee"
							...
							<area
								alt="Right_Foot" title="Right Foot"
						...
						<map id="back_image" name="backmap">
							...
							<area
								...
								<p id="body_parts">Left Hand</p>
							<area
								alt="Right Hand" title="Right Hand"
							...
							<area
								...
								<p id="body_parts">Left Foot</p>
							<area 
								alt="Right Foot" title="Right Foot"
